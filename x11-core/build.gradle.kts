...
val generatePrefs = tasks.register("generatePrefs") {
    ...
    doLast {
        ...
        sb.append("  }};\n\n")
        sb.append("  public Prefs() {}\n")
        sb.append("  public Prefs(Context ctx) {\n")
        sb.append("    attach(ctx, android.preference.PreferenceManager.getDefaultSharedPreferences(ctx));\n")
        sb.append("  }\n\n")
        sb.append("  @Override\n")
        sb.append("  public void attach(Context ctx, SharedPreferences preferences) {\n")
        sb.append("    super.attach(ctx, preferences);\n")
        sb.append("    Object legacyKeepScreenOn = preferences.getAll().get(\"keepScreenOn\");\n")
        sb.append("    if (legacyKeepScreenOn instanceof Boolean && !preferences.contains(\"screenIdleTimeout\"))\n")
        sb.append("      preferences.edit().putString(\"screenIdleTimeout\", ((Boolean) legacyKeepScreenOn) ? \"never\" : \"system\").commit();\n")
        sb.append("  }\n")
        sb.append("}\n")
