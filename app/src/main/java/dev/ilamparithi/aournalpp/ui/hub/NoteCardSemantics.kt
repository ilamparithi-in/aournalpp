...
fun rememberNoteAccessibilityActions(
    ...
    val openAsActionLabel = stringResource(R.string.action_open_as)
    ...
    val duplicateActionLabel = stringResource(R.string.action_duplicate)
    ...
    return remember(
        ...
        callbacks.onClick, callbacks.onOpenAs, callbacks.onTogglePin, callbacks.onShareExport,
        ...
        buildList {
            ...
            if (!isSelectionMode) {
                callbacks.onOpenAs?.let { openAs ->
                    add(CustomAccessibilityAction(openAsActionLabel) { openAs(); true })
                }
